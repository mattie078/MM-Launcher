...
exports.getConsoleOnLaunch = function (def = false) {
  return !def
    ? config.settings.game.consoleOnLaunch
    : DEFAULT_CONFIG.settings.game.consoleOnLaunch;
};
...
exports.getDiscordIntegration = function (def = false) {
  return !def
    ? config.settings.launcher.discordIntegration
    : DEFAULT_CONFIG.settings.launcher.discordIntegration;
};
